...
if __name__ == "__main__":
    ...
    submission_file_path = "data/test_runs/00_01_perfect_run.csv"
    # submission_file_path = "data/test_runs/00_02_imperfect_run.csv"
    # submission_file_path = "data/test_runs/01_not_1_or_2_tokens.csv"
    # submission_file_path = "data/test_runs/02_wrong_image_id.csv"
    # submission_file_path = "data/test_runs/03_same_image_id_more_than_once.csv"
    # submission_file_path = "data/test_runs/04_too_many_concepts.csv"
    # submission_file_path = "data/test_runs/05_same_concept_more_than_once.csv"
    # submission_file_path = "data/test_runs/06_not_all_image_ids_included.csv"
